...
const LandingPage = () => {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      ═══════════════════════════════════════════════ */}
      <section className="relative min-h-screen bg-[#09090b] overflow-hidden flex flex-col items-center justify-center pt-28 pb-32 px-4 sm:px-6">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/[0.06] border border-white/[0.08] text-xs font-semibold text-zinc-300 mb-8 backdrop-blur-sm"
          >
          ...
          <motion.h1
            variants={itemVariants}
            className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-display font-extrabold leading-[1.1] tracking-tight text-white mb-6"
          >
            Keep Your Health{' '}
        ...
        >
          ...
          >
            <div className="w-56 rounded-2xl bg-zinc-900/50 backdrop-blur-xl border border-white/[0.08] p-5 shadow-2xl shadow-black/40">
              {/* Header */}
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold text-zinc-400 uppercase tracking-wider">Heart Rate</span>
                </div>
        ...
        >
          ...
          >
            <div className="w-52 rounded-2xl bg-zinc-900/50 backdrop-blur-xl border border-white/[0.08] p-5 shadow-2xl shadow-black/40">
              <div className="flex items-center justify-between mb-4">
                <span className="text-xs font-semibold text-zinc-400 uppercase tracking-wider">AI Health Score</span>
        ...
        >
          ...
          >
            <div className="rounded-2xl bg-zinc-900/60 backdrop-blur-xl border border-white/[0.08] p-4 sm:p-5 shadow-2xl shadow-black/40">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h4 className="text-sm font-bold text-white">AuraHealth Assistant</h4>
              ...
              {/* Search Input */}
              <div className="relative flex items-center w-full h-12 rounded-xl bg-white/[0.04] border border-white/[0.08] overflow-hidden focus-within:border-primary-500/50 transition-colors">
                <div className="grid place-items-center h-full w-11 text-zinc-500">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                  </svg>
                </div>
                <input
                  className="h-full w-full outline-none text-sm text-zinc-200 pr-2 bg-transparent placeholder:text-zinc-600"
                  type="text"
                  id="hero-search"
                  placeholder="Describe what you're feeling today..."
                  aria-label="Search symptoms or find care"
                />
                <button
                  aria-label="Find Care Now"
                  className="h-full px-5 bg-primary-500 hover:bg-primary-400 text-white font-bold text-xs uppercase tracking-wider transition-colors whitespace-nowrap"
                >
                  Find Care
                </button>
              </div>
